...
import com.edgedetector.SourceManager
import com.edgedetector.crop.ICropView
import com.edgedetector.processor.Corners
import com.edgedetector.processor.TAG
import com.edgedetector.processor.cropPicture
import com.edgedetector.processor.enhancePicture
...
class CropPresenter(
  ...
  fun save() {
    val file = File(initialBundle.getString(EdgeDetectorModule.SAVE_TO) as String)
