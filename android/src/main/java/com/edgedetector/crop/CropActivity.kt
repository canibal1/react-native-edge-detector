...
import com.edgedetector.EdgeDetectorModule
import com.edgedetector.R
import com.edgedetector.base.BaseActivity
...
class CropActivity : BaseActivity(), ICropView.Proxy {
  ...
  override fun prepare() {
    this.initialBundle = intent.getBundleExtra(EdgeDetectorModule.INITIAL_BUNDLE) as Bundle

    this.title = initialBundle.getString(EdgeDetectorModule.CROP_TITLE)
  }
  ...
  override fun initPresenter() {
    val initialBundle = intent.getBundleExtra(EdgeDetectorModule.INITIAL_BUNDLE) as Bundle
  ...
  override fun onCreateOptionsMenu(menu: Menu): Boolean {
    Log.e("showMenuItems", showMenuItems.toString())
    ...
    menu.findItem(R.id.gray).title =
      initialBundle.getString(EdgeDetectorModule.CROP_BLACK_WHITE_TITLE) as String
    menu.findItem(R.id.reset).title =
      initialBundle.getString(EdgeDetectorModule.CROP_RESET_TITLE) as String

    if (showMenuItems) {
      Log.e("showMenuItem123123s", showMenuItems.toString())
      ...
      findViewById<ImageView>(R.id.done).visibility = View.GONE
  ...
  private fun changeMenuVisibility(showMenuItems: Boolean) {
    Log.e("showMenuItems1", showMenuItems.toString())
    Log.e("showMenuItems2", this.showMenuItems.toString())
    this.showMenuItems = showMenuItems
    Log.e("showMenuItems3", this.showMenuItems.toString())
