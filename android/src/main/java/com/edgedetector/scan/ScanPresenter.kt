...
import com.edgedetector.crop.CropActivity
import com.edgedetector.processor.Corners
import com.edgedetector.processor.processPicture
import com.edgedetector.scan.IScanView
...
class ScanPresenter constructor(
  ...
  private val initialBundle: Bundle
    ...
    fun detectEdge(pic: Mat) {
        ...
        cropIntent.putExtra(EdgeDetectorModule.INITIAL_BUNDLE, this.initialBundle)
