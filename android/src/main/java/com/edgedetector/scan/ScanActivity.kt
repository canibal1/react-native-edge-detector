...
import com.edgedetector.ERROR_CODE
import com.edgedetector.EdgeDetectorModule
import com.edgedetector.R
import com.edgedetector.REQUEST_CODE
...
class ScanActivity : BaseActivity(), IScanView.Proxy {
  ...
  override fun onNewIntent(intent: Intent) {
    ...
    // Handle the new intent, and possibly start the desired activity.
  }
  ...
  override fun prepare() {
    ...
    if (!initialBundle.containsKey(EdgeDetectorModule.FROM_GALLERY)) {
      this.title = initialBundle.getString(EdgeDetectorModule.SCAN_TITLE, "") as String
    }

    findViewById<View>(R.id.gallery).visibility =
      if (initialBundle.getBoolean(EdgeDetectorModule.CAN_USE_GALLERY, true))
        View.VISIBLE
      else View.GONE
    ...
    if (initialBundle.containsKey(EdgeDetectorModule.FROM_GALLERY) && initialBundle.getBoolean(EdgeDetectorModule.FROM_GALLERY, false)) {
      pickupFromGallery()
    }
  }
  ...
  override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
    ...
    if (requestCode == REQUEST_CODE) {
      if (resultCode == Activity.RESULT_OK) {
        ...
        if (intent.hasExtra(EdgeDetectorModule.FROM_GALLERY) && intent.getBooleanExtra(EdgeDetectorModule.FROM_GALLERY, false))
          finish()
      }
    }
